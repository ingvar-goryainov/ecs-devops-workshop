...
aws iam get-role --role-name "doc" || aws iam create-service-linked-role --aws-service-name "ecs.amazonaws.com" && echo "Created role: 'AWSServiceRoleForECS'" >> /tmp/roles_created.txt
